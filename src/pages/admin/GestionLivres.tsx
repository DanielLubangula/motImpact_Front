    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition w-full sm:w-auto"
        >
      ...
      {livres.length === 0 ? (
        ...
        <>
          ...
          <div className="lg:hidden space-y-4">
            {livres.map((livre) => (
              <div key={livre.id} className="bg-white rounded-xl shadow p-4 sm:p-6 hover:shadow-lg transition">
                  ...
                  {livre.couverture && (
                    <div className="flex-shrink-0 self-center sm:self-start">
                      <img 
                        src={livre.couverture} 
                        alt={livre.titre}
                        className="w-20 h-28 sm:w-16 sm:h-24 object-cover rounded border border-gray-200"
                      />
                    </div>
                  )}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                      <div className="flex-1">
                        <h3 className="text-lg font-bold text-gray-900 mb-2 line-clamp-2">{livre.titre}</h3>
                        ...
                        <div className="flex flex-wrap items-center gap-2 mb-4">
                          ...
                          {livre.statut === 'payant' && (
                            <span className="font-semibold text-green-600 text-sm">{livre.prix}€</span>
                          )}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                      <button
                        onClick={() => handleEdit(livre)}
                        className="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-4 py-2 text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-lg transition-colors border border-blue-200 hover:border-blue-300"
                      >
                        <Edit2 className="w-4 h-4" />
                        Modifier
                      </button>
                      <button
                        onClick={() => handleDelete(livre.id)}
                        className="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-4 py-2 text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors border border-red-200 hover:border-red-300"
                      >
                        <Trash2 className="w-4 h-4" />
                        Supprimer
                      </button>
